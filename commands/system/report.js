...
module.exports = {
        ...
        run: async (client, message, args, config, language) => {
            ...
            if (!mention) return message.reply(`${language.invalidargs} | IE: **${config.prefix1}report @system_gray This is an example**`)

            if (!reason) return message.reply(`${language.invalidargs} | EX: **${config.prefix1}report @system_gray This is an example**`)
