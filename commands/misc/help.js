...
function menu(message, config, language) {
    ...
    embed.setFooter(`${config.shortname} bot ${language.madeby} | System Gray`)
    ...
    embed.addField(`${language.admincmds}`, " `ban` `kick` `purge` `announce` `rem-tick [id]` `addrole` `removerole`")
    ...
    embed.addField(`${language.servercmds}`, "`info` `players` `rules` `tinfo`")
